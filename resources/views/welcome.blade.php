...
<body>
    ...
    <header class="header-section">
        <div class="container">
            ...
            <ul class="main-menu" >
                ...
                <li><a href="{{route('viewAP')}}">view appointment</a></li>
  ...
  <button type="button"  class="fa fa-cog" aria-hidden="true" data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false">
  </button>
  <div class="dropdown-menu dropdown-menu-lg-right">
    <a href="{{route('viewP')}}"  type="button">View patient</a>
    <a href="{{route('create_doctor')}}"  type="button">create a doctor</a>
